...
from rule_engine import inspect_rule, inspect_stamp, process_job
...
def main() -> int:
    ...
    try:
        if args.inspect_rule_json is not None:
        ...
        if args.inspect_json is None and args.inspect_rule_json is None:
