...
- [`apps/pdf-batch-editor`](apps/pdf-batch-editor) — Tauri-приложение «Поля ПД» для анализа структуры и пакетного редактирования PDF проектной документации: штампы СПДС, произвольный текст, титульные листы и логотипы.
