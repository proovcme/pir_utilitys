...
- [`apps/pdf-batch-editor`](apps/pdf-batch-editor) — Tauri-приложение «Редактор содержания ПД» для поиска, замены, удаления и добавления содержимого PDF; штамп СПДС и операции со страницами подключены как специализированные инструменты.
