...
- [`apps/pdf-batch-editor`](apps/pdf-batch-editor) — Tauri-приложение «ПД Редактор» для пакетной корректировки PDF: поиск, замена и удаление содержимого, работа со страницами, штампами СПДС, титульными листами и логотипами.
