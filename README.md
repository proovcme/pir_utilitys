...
Публичная редакция только с нормативным мастером ФГИС ПИР:
...
- публичная справочная — отдельная точка входа `src/public-main.tsx`, опубликованная по адресу `https://les.ovc.me/pircalc/`.
