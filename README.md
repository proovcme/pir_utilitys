...
Ниже находятся параметры проекта, стадии, разбивка по группам затрат и коэффициенты. В этом экране не редактируются ставки и массовые значения строк: они вынесены туда, где используются.
